...
def Test_import():
  ...
  QStackedWidget.WaitQtObject("ProjectViewWidget", "", 1, 3).QtObject("project_tools").QtObject("HE_PushButton", "",3).Click()
    
  PlayerAreaWidget.QtObject("HorizontalFOVTool", "", 1).Drag(99, 203, 197, 12)
  time.sleep(3)
